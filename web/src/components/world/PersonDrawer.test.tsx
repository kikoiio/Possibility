...
function renderDrawer(canEditMemories: boolean, memories = [memory]) {
  const focus: PersonFocus = {
    person: { id: 'resident-1', name: 'Resident' }, state: null, thoughts: [], schedule: null, memories,
  }
  return renderToStaticMarkup(createElement(PersonDrawer, {
    focus, loading: false, liveState: null, fallbackName: 'Resident', personId: 'resident-1', canEditMemories,
